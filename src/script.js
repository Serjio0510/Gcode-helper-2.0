...
function calculateGear() {
    ...
    console.log({module, displacement, diameterNom});
    const displacementCoefficient = displacement / module; 

    // Диаметр ролика
    const rollerDiameter = 1.75 * module;
    ...
    // Угол профиля в точке на концентрической окружности диаметра/////// убрать с вывода
